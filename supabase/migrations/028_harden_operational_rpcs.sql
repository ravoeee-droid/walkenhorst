alter function public.energy_record_call_outcome(uuid,text,text,timestamptz) security invoker;
...
revoke all on function public.energy_system_health() from public, anon, authenticated;
grant execute on function public.energy_system_health() to service_role;
